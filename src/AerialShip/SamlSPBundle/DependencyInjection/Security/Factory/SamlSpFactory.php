...
class SamlSpFactory extends AbstractFactory
{
    ...
    public function addConfiguration(NodeDefinition $node)
    {
        ...
        $node->children()
            ...
            ->scalarNode('login_path')->defaultValue('/saml/sp/login')->validate()
            ->ifTrue(function ($v) {return '' === $v;})
            ->thenInvalid('Cannot be the empty string')
            ->end()->end()
            ->scalarNode('check_path')->defaultValue('/saml/sp/acs')->validate()
            ->ifTrue(function ($v) {return '' === $v;})
            ->thenInvalid('Cannot be the empty string')
            ->end()->end()
            ->scalarNode('logout_path')->defaultValue('/saml/sp/logout')->validate()
            ->ifTrue(function ($v) {return '' === $v;})
            ->thenInvalid('Cannot be the empty string')
            ->end()->end()
